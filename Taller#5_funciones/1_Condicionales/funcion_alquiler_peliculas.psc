...
Proceso funcion_alquiler_peliculas
	Definir rta, rtaOpcion Como Caracter;
	...
	rtaOpcion <- opciones(opcion);
FinProceso

SubProceso retorno <- opciones(opcion)
	Definir retorno, observacion_rta Como Caracter;
	Definir observacion, pelicula Como Entero;
	Segun opcion hacer
		1: 
